...
<head>
  ...
  <title>Services - लोक उत्थान पहल फाउंडेशन</title>
...
.corner-number {
  ...
  background-color: #feb900; /* Bright background color */
  padding: 5px 10px; /* Adjust padding as needed */
  border-radius: 50%; /* Circular background */
  margin-left: 15px; /* Space between the heading and the number */
  position: absolute;
  top: 50%; /* Position in the middle vertically */
  right: -30px; /* Position to the right of the heading */
...
<body class="services-page">
  ...
  <main class="main">
    ...
    <div class="container section-title" data-aos="fade-up"   id="workarea">
...
<hr>
    ...
    <div class="container section-title" data-aos="fade-up">
        <h2 style="margin-top: 50px;">Employment</h2>
      <!--  <p>We have team of professional, dedictaed and hard-working leaders who had made a strong impact on community in their respective areas</p>
-->  </div>
    ...
    <div class="container section-title" data-aos="fade-up" id="workarea4">
        <h2 style="margin-top: 50px;">Skill Training</h2>
      <!--  <p>We have team of professional, dedictaed and hard-working leaders who had made a strong impact on community in their respective areas</p>
-->  </div>
    <section id="services" class="services section">
...
<div class="container section-title"   data-aos="fade-up">
        <h2 style="margin-top: 50px;">Enviroment</h2>
      <!--  <p>We have team of professional, dedictaed and hard-working leaders who had made a strong impact on community in their respective areas</p>
-->  </div>
    <section id="alt-services-2" class="alt-services-2 section">
...
Environmental Commitment</h3>
    ...
    <hr>
    <div class="container section-title"  data-aos="fade-up">
        <h2 style="margin-top: 50px;">Job-oriented</h2>
      <!--  <p>We have team of professional, dedictaed and hard-working leaders who had made a strong impact on community in their respective areas</p>
-->  </div>
...
<div class="container section-title" data-aos="fade-up">
        <h2 style="margin-top: 50px;">Self-Help-Group</h2>
      <!--  <p>We have team of professional, dedictaed and hard-working leaders who had made a strong impact on community in their respective areas</p>
-->  </div>
    <section id="services" class="services section">
