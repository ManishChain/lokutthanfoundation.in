...
$company_id = $_SESSION[SESS.'data']['company_id_cus'];
$loginrolename = $_SESSION[SESS.'data']['rolename'];

$csa_id = $_SESSION[SESS.'data']['csa_id'];
$csaQuery = "select * from csa where c_id = '$csa_id' limit 1 ";
$runCsa = mysqli_query($dbc,$csaQuery);
$csaData = mysqli_fetch_assoc($runCsa);
// pre($csaData);die;
...
<script type="text/javascript">
    function ShowHideDiv() {
        ...
        a48.style.display = ddlPassport.value == "8" ? "block" : "none";
         ...
         var kbz = document.getElementById("kbz");
        kbz.style.display = ddlPassport.value == "kbz" ? "block" : "none";
        ...
        <option value="Y">Normal</option>
         <?php //if($dealer_id==2000){ ?>   
            <!--  <option value="8">8 ON A4 Sheet</option> 
              ...
              <!-- <option value="kbz">12 ON A5 Sheet</option> -->
          <?php //} ?>
...
// pre($value); die(); 
  ...
  $challan_pid = $value['id'];

  $irn_details = "select * from einvoice_api_logs where status = 1 and challan_id = ".$challan_pid." limit 1 "; 
  $irn_details_run = mysqli_query($dbc,$irn_details);
  $irn_details_execute = mysqli_fetch_assoc($irn_details_run);

  $irn = $irn_details_execute['irn'];
  $qr_path = 'https://demo.msell.in/public/'.$irn_details_execute['qr_path'];


// die();
// echo $company_id;die;

if($loginrolename == 'DEPO'){
  $ch_created_for_dealer_id = $value['ch_created_for_dealer_id'];
  if($ch_created_for_dealer_id == 0){
    $ch_created_for_dealer_id = $value['ch_retailer_id'];
  }
}else{
  $ch_created_for_dealer_id = $value['ch_retailer_id'];
}
...
// }
   ...
   $wheresd = "SELECT * from dealer where `id`=$ch_created_for_dealer_id";
  $rund = mysqli_query($dbc,$wheresd);
  $finald = mysqli_fetch_assoc($rund);
      ...
      <tr>
        <td valign="top" colspan="8" style="width:50%;">
          ...
          <table border="0" style="font-family:'Times New Roman', Times, serif; font-size:10pt;">
            ...
            <tr>
                <td colspan="3">(AUTH. <?php echo $_SESSION[SESS.'data']['rolename']; ?> OF <?php echo $_SESSION[SESS.'data']['company_name']; ?>)</td>
            </tr>
            <?php if($company_id == 243) { ?>
            <tr>
              <td><strong>6803008700000578 </strong></td>
            </tr>
            <tr>
              <td><strong>PUNB0680300 </strong></td>
            </tr>
            <tr>
              <td><strong>PUNJAB NATIONAL BANK (INDIA) BARWANI </strong></td>
            </tr>
            <?php } ?>
            <tr>
                <td colspan="3" style="">
			...
			<tr>
              <?php if($_SESSION[SESS.'data']['rolename'] == 'DEPO'){ ?>
              <td><strong>GSTIN. No.: </strong><?php echo $csaData['gst_no']; ?></td>
              <?php }else{ ?>
        ...
        <?php if($company_id == 243){ 
           ...
           $getDispatchId = "select van.van_no,van.driver_name from van inner join daily_dispatch on daily_dispatch.van_no = van.van_no inner join daily_dispatch_details on daily_dispatch_details.dispatch_id =daily_dispatch.dispatch_id where daily_dispatch_details.ch_id = '$_GET[id]' limit 1 "; 
          $runDispth = mysqli_query($dbc,$getDispatchId);
          $dispaAssoc = mysqli_fetch_assoc($runDispth);

          ?>

          <tr>
            <td>
              <strong>Driver Name.:- </strong><?php echo $dispaAssoc['driver_name']; ?><br>
              <strong>Vehicle Details.:- </strong><?php echo $dispaAssoc['van_no']; ?>
            </td>
          </tr>
        ...
        <td valign="top" colspan="8">
          ...
          <table border="0" style="font-family:'Times New Roman', Times, serif; font-size:10pt;">
            ...
            <?php if($_SESSION[SESS . 'data']['rolename'] == 'DEPO'){ ?>
               ...
               <tr>
              <td><strong>BILL TO : <?php echo $finald['name']; ?></strong> </td>
...
<!--        <td align="right"><strong>Authorised Signatory</strong> </td>-->
          ...
          <?php } ?>
            ...
            <tr>
                <td colspan="2"><strong> Dealer: <?php echo $finald['name']; ?></strong><br/><strong>Address: </strong>
                <?php echo $finald['address'].' '.$finald['pin_no']; ?> <?php echo $value['adr']['pin_no']; ?>
                </td>
            </tr>

             <?php }elseif ($_SESSION[SESS . 'data']['rolename'] == 'Super Admin') {  ?>

             <tr>
                <td colspan="2"><strong> SS: <?php echo $finald['name']; ?></strong><br/>
                  <strong>Address: </strong>
                <?php echo $finald['address'].' '.$finald['pin_no']; ?> <br>
                <strong>Party Mobile Number: </strong>
                <?php echo !empty($finald['landline'])?$finald['landline']:$finald['other_numbers']; ?> <br>

                <strong>GSTIN. No.: </strong><?php echo $finald['gst_no']; ?><br>
            ...
            <tr>
                <td colspan="2">
                  <strong> Retailer: <?php echo $value['retailer_id']; ?></strong><br/>
                  <strong> Retailer Contact Person Name: <?php echo $value['contact_per_name']; ?></strong><br/>

                  <strong>Address: </strong>
                <?php echo $value['retailer_address']; ?> <?php echo $value['adr']['pin_no']; ?>
                </td>
            </tr>
          ...
          <?php } ?>
            ...
            <?php if($_SESSION[SESS . 'data']['rolename'] == 'DEPO'){ ?>
            <tr>
                <td colspan="2"><strong> PH No: </strong><?php echo $finald['landline'];?> / <?php echo $finald['other_numbers'];?>
                </td>
            </tr>
             ...
             <!-- <tr>
                <td colspan="2"><strong> SS: <?php echo $finald['name']; ?></strong><br/><strong>Address: </strong>
                <?php echo $finald['address'].' '.$finald['pin_no']; ?> 
                </td>
            </tr> -->
            ...
            <?php }else{ ?>
            <tr>
                <td colspan="2"><strong> PH No: </strong><?php echo $value['retailer_contact'];?> 
                </td>
            </tr>
          <?php } ?>
            ...
            <?php if($_SESSION[SESS . 'data']['rolename'] == 'DEPO'){ ?>
               <tr>
                 <td colspan="2"><strong>GSTIN.-:</strong> <?php  echo strtoupper($finald['tin_no']); ?></td> 
            </tr>
            ...
            <?php }else{ ?>
             <tr>
                 <td colspan="2"><strong>GSTIN.-:</strong> <?php  echo strtoupper($value['retailer_gst']); ?></td> 
            </tr>
            <tr>
          ...
          <?php } ?>
            ...
            ?>
                <tr>
                  <td colspan="8"><strong>IRN No.: <?php echo $irn; ?></strong></td>
                </tr>
                <tr>
                  <td><img src="<?php echo $qr_path; ?>" alt=" " height="100" width="100"></td>
                </tr>
            <?php
            }
            ?>
...
<td valign="top" colspan="8">
          ...
          <table border="0" style="font-family:'Times New Roman', Times, serif; font-size:10pt;">
            ...
            <?php if($_SESSION[SESS . 'data']['rolename'] == 'DEPO'){ ?>
               ...
               <tr>
              <td><strong>SHIP TO : <?php echo $finald['name']; ?></strong> </td>
<!--        <td align="right"><strong>Authorised Signatory</strong> </td>-->
              <td valign="top"></td>
            </tr>
             ...
             <tr>
                <td colspan="2"><strong> SHIP TO : <?php echo $finald['name']; ?></strong><br/><strong>Address: </strong>
                <?php echo $finald['address'].' '.$finald['pin_no']; ?> <br>
...
<!--        <td align="right"><strong>Authorised Signatory</strong> </td>-->
          ...
          <?php }else{ ?>
            <tr>
                <td colspan="2"><strong> Retailer: <?php echo $value['retailer_id']; ?></strong><br/>
                  <strong> Retailer Contact Person Name: <?php echo $value['contact_per_name']; ?></strong><br/>
          ...
          <?php if($company_id == 213 && $_SESSION[SESS . 'data']['rolename'] == 'DISTRIBUTOR'){ ?>
            <tr>
                 <td colspan="2"><strong>PO No.-:</strong> <?php  echo strtoupper($value['po_no']); ?></td> 
            </tr>
          <?php } ?>
      ...
      <tr style="font-weight:bold;">
        ...
        <td rowspan="2" style="width:15%" align="center">Weight(KG)</td>
    ...
    foreach($value['challan_item'] as $key1=>$value1){ 
      ...
      if($value1['cd_type']==1){
       ...
       <?php 
             ...
             // else{
       $ch_id = $_GET['id'];
        $query_q = "SELECT batch_no,DATE_FORMAT(`mfg_date`,'%b-%Y') AS mfg FROM challan_order_details WHERE ch_id=$ch_id AND product_id=".$value1['product_id']." AND MRP='".$value1['mrp']."' LIMIT 1";
                $ch_id = $_GET['id'];
               $x = mysqli_query($dbc,"SELECT batch_no,DATE_FORMAT(`mfg_date`,'%b-%Y') AS mfg FROM challan_order_details WHERE ch_id=$ch_id AND product_id=".$value1['product_id']." AND MRP='".$value1['mrp']."' LIMIT 1");        
               $more_info = mysqli_fetch_assoc($x);         
             // }
              ...
              <tr style="font-weight:bold;">
                ...
                <td rowspan="2" style="width:40%" align="center">Weight(KG)</td>
                <td rowspan="2" style="width:5%" align="center">HSN Code</td>
				<td rowspan="2" style="width:5%" align="center">Batch No.</td>
        <td rowspan="2" style="width:5%" align="center">Mfg.Date</td>
...
<!--        <td style="border-bottom:none;border-top:none;height:35px;"> <?php echo $value1['comunity_code'];?></td>-->
        ...
        <td style="border-bottom:none;border-top:none;height:35px;">
         <?php
         if($company_id == 215 || $company_id == 40){
           echo ROUND(($value1['qty']*$value1['weight'])/1000,3);
         }else{
           echo '';
         } 
         ?>
...
<!--        <td style="border-bottom:none;border-top:none;height:36px;" align="right"> <?php echo my2digit($surcharge);?></td>
  ...
  <?php $net_amt = $value1['taxable_amt']; ?>
    ...
    <?php
       ...
       <?php if($dealer_state_id == $retailer_state_id){ $col = '2'; $col1 = '2'; $col2 = '21'; $col3 = '3'; }else{
      ...
      <tr style="border-left:0px;">
          <td colspan="19" align="Left" style="border-right:0px;">
...
<!--           <td colspan="5">
        ...
        <tr style="font-size:11pt;">
         ...
         <?php 
         $gamount = $grandtotal-$value['discount_amt'];
        ...
        <tr style="font-size:11pt;">
         ...
         <td colspan="<?php echo $col3; ?>" style="border-left:0px;"> <span style="float:right"><b><?php echo price_to_words(round($gamount));?></b></span></td>

       </tr>  
        
        <tr style="font-size:11pt;">
         <!-- <td colspan="23">Amount of Invoice (in Words) Rupees. <b><?php echo strtoupper(price_to_words($value['amount'],2));?></b> -->
         <td colspan="24">Amount of Invoice (in Words) Rupees. <b><?php echo strtoupper(price_to_words($gamount,2));?></b>
          <!--ONE LAC SIX THOUSAND FOUR HUNDRED TWENTY FIVE ONLY.--></td>
       </tr>
       <tr>
        <td colspan="20"></td>
        <td colspan="20"></td>
       ...
       <tr>
         <td valign="top" colspan="14" style="border:none;">
           <span style="font-size:9pt;">
                        <strong>Terms & Conditions:</strong><br>
                        <?php if($company_id == 243) { ?>
                          <strong>Goods once sold will not be taken back or exchanged Bills not paid due date will attract 24% interest.<br>
                           All disputes subject to BARWANI jurisdication only. Prescribed Sales Tax Declaration will be given.</strong>
                        <?php } ?>
