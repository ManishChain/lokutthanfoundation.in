...
<head>
  ...
  <title>About - लोक उत्थान पहल फाउंडेशन</title>
        ...
        <div class="row justify-content-around gy-4">
          ...
          <div class="col-lg-5 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="400">
              ...
              <div>
                <h4><a href="" class="stretched-link">Empathy </a></h4>
                <p>Our goal is to empower marginalized and needy individuals by providing a voice and being a weapon for the vulnerable</p>
              </div>
            </div><!-- End Icon Box -->
            ...
            <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="500">
              ...
              <div>
                <h4><a href="" class="stretched-link">Ensuring transparency</a></h4>
                <p>Our role is to ensure that the government addresses citizens' complaints and resolves issues, promoting accountability</p>
              </div>
            </div><!-- End Icon Box -->
            ...
            <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="600">
              <i class="bi bi-brightness-high flex-shrink-0"></i>
              <div>
                <h4><a href="" class="stretched-link">Helping attitude</a></h4>
                <p>We can help local authorities improve and adapt by sharing our knowledge and experience in specific areas</p>
              </div>
            </div><!-- End Icon Box -->
      ...
      <div class="container">
        ...
        <div class="row justify-content-around gy-4">
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center order-2 order-lg-1" data-aos="fade-up" data-aos-delay="100">
            <h3>Focus Areas</h3>
            <p>Our fundamental purpose is to improve the world and make it a better place for all suffering humans. The goal of our organization is to foster trust among people for the benefit of humanity. It will concentrate intensely on all issues that directly affect human life. Our top aim is to preserve human rights and investigate social issues that affect the poorest members of society, with a particular emphasis on environmental issues such as overt traffic and pollution in specific areas. We are determined to stand up for the weak and become their weapons as per their needs. We are also aware about the evolution and improvement of society's social and political conditions on a broader level. Primarily our focus is on these areas</p>
